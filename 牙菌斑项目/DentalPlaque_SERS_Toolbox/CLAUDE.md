...
```
cd E:\牙菌斑项目\DentalPlaque_SERS_Toolbox
claude
```
...
Or run directly:
```
matlab -batch "addpath(genpath('E:\牙菌斑项目\DentalPlaque_SERS_Toolbox')); main;"
```
...
| 2.5 | Scientific Review | ✅ Complete (92/100) |
...
- Path: `D:\MATLAB_2025b\bin\matlab`
...
3. Data folder at `E:\牙菌斑项目\牙菌斑SERS光谱\`

### First Run
```matlab
addpath(genpath('E:\牙菌斑项目\DentalPlaque_SERS_Toolbox'))
main              % runs read → preprocess → qc → dashboard → phase2
```

### Adding New Patients
1. Place CSV files in `E:\牙菌斑项目\牙菌斑SERS光谱\<Group>\<PatientID>\`
